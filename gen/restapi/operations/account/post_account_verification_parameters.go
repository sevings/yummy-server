...
func (o *PostAccountVerificationParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostAccountVerificationParams) validateXUserKey(formats strfmt.Registry) error {
