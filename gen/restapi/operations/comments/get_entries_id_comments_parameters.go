...
func (o *GetEntriesIDCommentsParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEntriesIDCommentsParams) validateXUserKey(formats strfmt.Registry) error {
