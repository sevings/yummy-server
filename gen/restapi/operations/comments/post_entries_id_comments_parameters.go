...
// PostEntriesIDCommentsParams contains all the bound params for the post entries ID comments operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEntriesIDComments
...
func (o *PostEntriesIDCommentsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PostEntriesIDCommentsParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEntriesIDCommentsParams) validateXUserKey(formats strfmt.Registry) error {
