...
type GetDesignHandlerFunc func(GetDesignParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetDesignHandlerFunc) Handle(params GetDesignParams) middleware.Responder {
	return fn(params)
}

// GetDesignHandler interface for that can handle valid get design params
type GetDesignHandler interface {
	Handle(GetDesignParams) middleware.Responder
}
