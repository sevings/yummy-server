...
func (o *GetEntriesBestParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEntriesBestParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *GetEntriesBestParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
