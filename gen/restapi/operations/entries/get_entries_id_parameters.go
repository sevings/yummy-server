...
func NewGetEntriesIDParams() GetEntriesIDParams {
	var ()
	return GetEntriesIDParams{}
}

// GetEntriesIDParams contains all the bound params for the get entries ID operation
...
func (o *GetEntriesIDParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEntriesIDParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *GetEntriesIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesIDParams) validateID(formats strfmt.Registry) error {
