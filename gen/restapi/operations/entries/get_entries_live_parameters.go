...
func (o *GetEntriesLiveParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetEntriesLiveParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *GetEntriesLiveParams) bindLongerThan(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesLiveParams) bindShorterThan(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
