...
type PutEntriesIDHandlerFunc func(PutEntriesIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PutEntriesIDHandlerFunc) Handle(params PutEntriesIDParams) middleware.Responder {
	return fn(params)
}

// PutEntriesIDHandler interface for that can handle valid put entries ID params
type PutEntriesIDHandler interface {
	Handle(PutEntriesIDParams) middleware.Responder
}
