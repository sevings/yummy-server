...
type DeleteEntriesIDFavoriteHandlerFunc func(DeleteEntriesIDFavoriteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteEntriesIDFavoriteHandlerFunc) Handle(params DeleteEntriesIDFavoriteParams) middleware.Responder {
	return fn(params)
}
...
type DeleteEntriesIDFavoriteHandler interface {
	Handle(DeleteEntriesIDFavoriteParams) middleware.Responder
}
