...
func (o *GetEntriesIDFavoriteParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetEntriesIDFavoriteParams) validateXUserKey(formats strfmt.Registry) error {
