...
type PutEntriesIDFavoriteHandlerFunc func(PutEntriesIDFavoriteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PutEntriesIDFavoriteHandlerFunc) Handle(params PutEntriesIDFavoriteParams) middleware.Responder {
	return fn(params)
}
...
type PutEntriesIDFavoriteHandler interface {
	Handle(PutEntriesIDFavoriteParams) middleware.Responder
}
