...
// GetUsersMeParams contains all the bound params for the get users me operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetUsersMe
...
func (o *GetUsersMeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetUsersMeParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetUsersMeParams) validateXUserKey(formats strfmt.Registry) error {
