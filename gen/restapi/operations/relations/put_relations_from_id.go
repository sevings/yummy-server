...
type PutRelationsFromIDHandlerFunc func(PutRelationsFromIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PutRelationsFromIDHandlerFunc) Handle(params PutRelationsFromIDParams) middleware.Responder {
	return fn(params)
}
...
type PutRelationsFromIDHandler interface {
	Handle(PutRelationsFromIDParams) middleware.Responder
}
