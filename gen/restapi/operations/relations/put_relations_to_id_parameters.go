...
func (o *PutRelationsToIDParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PutRelationsToIDParams) validateXUserKey(formats strfmt.Registry) error {
