...
type GetUsersIDHandlerFunc func(GetUsersIDParams, *models.UserID) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUsersIDHandlerFunc) Handle(params GetUsersIDParams, principal *models.UserID) middleware.Responder {
	return fn(params, principal)
}

// GetUsersIDHandler interface for that can handle valid get users ID params
type GetUsersIDHandler interface {
	Handle(GetUsersIDParams, *models.UserID) middleware.Responder
}
