...
func (o *GetUsersIDParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUsersIDParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *GetUsersIDParams) validateID(formats strfmt.Registry) error {
