...
// DeleteEntriesIDVoteParams contains all the bound params for the delete entries ID vote operation
// typically these are obtained from a http.Request
//
// swagger:parameters DeleteEntriesIDVote
type DeleteEntriesIDVoteParams struct {
...
func (o *DeleteEntriesIDVoteParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteEntriesIDVoteParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *DeleteEntriesIDVoteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteEntriesIDVoteParams) validateID(formats strfmt.Registry) error {
