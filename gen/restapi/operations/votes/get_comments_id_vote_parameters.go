...
// GetCommentsIDVoteParams contains all the bound params for the get comments ID vote operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetCommentsIDVote
type GetCommentsIDVoteParams struct {
...
func (o *GetCommentsIDVoteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetCommentsIDVoteParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetCommentsIDVoteParams) validateXUserKey(formats strfmt.Registry) error {
...
func (o *GetCommentsIDVoteParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
