...
// NewGetEntriesIDVoteParams creates a new GetEntriesIDVoteParams object
// with the default values initialized.
func NewGetEntriesIDVoteParams() GetEntriesIDVoteParams {
	var ()
	return GetEntriesIDVoteParams{}
}

// GetEntriesIDVoteParams contains all the bound params for the get entries ID vote operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetEntriesIDVote
type GetEntriesIDVoteParams struct {
...
func (o *GetEntriesIDVoteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetEntriesIDVoteParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetEntriesIDVoteParams) validateXUserKey(formats strfmt.Registry) error {
