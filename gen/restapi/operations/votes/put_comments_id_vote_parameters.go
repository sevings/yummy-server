...
// PutCommentsIDVoteParams contains all the bound params for the put comments ID vote operation
// typically these are obtained from a http.Request
//
// swagger:parameters PutCommentsIDVote
type PutCommentsIDVoteParams struct {
...
func (o *PutCommentsIDVoteParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PutCommentsIDVoteParams) validateXUserKey(formats strfmt.Registry) error {
