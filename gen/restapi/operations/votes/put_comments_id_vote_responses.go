...
func (o *PutCommentsIDVoteOK) WithPayload(payload *models.VoteStatus) *PutCommentsIDVoteOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the put comments Id vote o k response
func (o *PutCommentsIDVoteOK) SetPayload(payload *models.VoteStatus) {
	o.Payload = payload
}
...
/*PutCommentsIDVoteNotFound Entry not found
