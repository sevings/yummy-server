...
func (o *GetEntriesIDWatchingParams) bindXUserKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetEntriesIDWatchingParams) validateXUserKey(formats strfmt.Registry) error {
