...
// ContextValidate validates this get adm grandson o k body based on context it is used
func (o *GetAdmGrandsonOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
