...
// PutCommentsIDMaxParseMemory sets the maximum size in bytes for
// the multipart form parser for this operation.
//
// The default value is 32 MB.
// The multipart parser stores up to this + 10MB.
var PutCommentsIDMaxParseMemory int64 = 32 << 20
...
func (o *PutCommentsIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if err := r.ParseMultipartForm(PutCommentsIDMaxParseMemory); err != nil {
