...
// NewGetEntriesUsersByNameNameParams creates a new GetEntriesUsersByNameNameParams object
...
// GetEntriesUsersByNameNameParams contains all the bound params for the get entries users by name name operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetEntriesUsersByNameName
type GetEntriesUsersByNameNameParams struct {
...
func (o *GetEntriesUsersByNameNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *GetEntriesUsersByNameNameParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesUsersByNameNameParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetEntriesUsersByNameNameParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesUsersByNameNameParams) validateName(formats strfmt.Registry) error {
...
func (o *GetEntriesUsersByNameNameParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesUsersByNameNameParams) validateSort(formats strfmt.Registry) error {
...
func (o *GetEntriesUsersByNameNameParams) bindTag(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetEntriesUsersByNameNameParams) validateTag(formats strfmt.Registry) error {
