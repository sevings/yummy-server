...
// NewPostEntriesMeParams creates a new PostEntriesMeParams object
// with the default values initialized.
func NewPostEntriesMeParams() PostEntriesMeParams {
	var (
		isVotableDefault = bool(false)
		titleDefault     = string("")
	)
	return PostEntriesMeParams{
...
// PostEntriesMeParams contains all the bound params for the post entries me operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEntriesMe
type PostEntriesMeParams struct {
...
func (o *PostEntriesMeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PostEntriesMeParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEntriesMeParams) validateContent(formats strfmt.Registry) error {
...
func (o *PostEntriesMeParams) bindIsVotable(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostEntriesMeParams) bindPrivacy(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEntriesMeParams) validatePrivacy(formats strfmt.Registry) error {
...
func (o *PostEntriesMeParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostEntriesMeParams) validateTitle(formats strfmt.Registry) error {
...
func (o *PostEntriesMeParams) bindVisibleFor(rawData []string, hasKey bool, formats strfmt.Registry) error {
