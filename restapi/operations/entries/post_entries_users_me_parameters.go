...
// NewPostEntriesUsersMeParams creates a new PostEntriesUsersMeParams object
...
// PostEntriesUsersMeParams contains all the bound params for the post entries users me operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEntriesUsersMe
type PostEntriesUsersMeParams struct {
...
func (o *PostEntriesUsersMeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PostEntriesUsersMeParams) bindContent(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *PostEntriesUsersMeParams) bindIsVotable(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostEntriesUsersMeParams) bindTitle(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostEntriesUsersMeParams) validateTitle(formats strfmt.Registry) error {
...
func (o *PostEntriesUsersMeParams) bindVisibleFor(rawData []string, hasKey bool, formats strfmt.Registry) error {
