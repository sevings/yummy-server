...
// GetRelationsFromNameParams contains all the bound params for the get relations from name operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetRelationsFromName
type GetRelationsFromNameParams struct {
...
func (o *GetRelationsFromNameParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetRelationsFromNameParams) validateName(formats strfmt.Registry) error {
