...
type GetUsersIDFollowingsHandlerFunc func(GetUsersIDFollowingsParams, *models.UserID) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUsersIDFollowingsHandlerFunc) Handle(params GetUsersIDFollowingsParams, principal *models.UserID) middleware.Responder {
...
type GetUsersIDFollowingsHandler interface {
	Handle(GetUsersIDFollowingsParams, *models.UserID) middleware.Responder
}
