...
// NewGetUsersNameFollowingsParams creates a new GetUsersNameFollowingsParams object
// with the default values initialized.
func NewGetUsersNameFollowingsParams() GetUsersNameFollowingsParams {
	...
	return GetUsersNameFollowingsParams{
		After: &afterDefault,
...
// GetUsersNameFollowingsParams contains all the bound params for the get users name followings operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetUsersNameFollowings
type GetUsersNameFollowingsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetUsersNameFollowingsParams() beforehand.
func (o *GetUsersNameFollowingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetUsersNameFollowingsParams) bindAfter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUsersNameFollowingsParams) bindBefore(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
