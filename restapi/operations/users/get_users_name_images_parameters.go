...
// NewGetUsersNameImagesParams creates a new GetUsersNameImagesParams object
// with the default values initialized.
func NewGetUsersNameImagesParams() GetUsersNameImagesParams {
	...
	return GetUsersNameImagesParams{
		After: &afterDefault,
...
// GetUsersNameImagesParams contains all the bound params for the get users name images operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetUsersNameImages
type GetUsersNameImagesParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetUsersNameImagesParams() beforehand.
func (o *GetUsersNameImagesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetUsersNameImagesParams) bindAfter(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetUsersNameImagesParams()
		return nil
	}
