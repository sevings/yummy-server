...
func (o *DeleteCommentsIDVoteOK) WithPayload(payload *models.VoteStatus) *DeleteCommentsIDVoteOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete comments Id vote o k response
func (o *DeleteCommentsIDVoteOK) SetPayload(payload *models.VoteStatus) {
	o.Payload = payload
}
...
/*DeleteCommentsIDVoteNotFound Entry not found
